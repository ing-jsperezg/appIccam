...
<div class="page-content">
			...
			<ul class="header-actions">
							...
							<li>
								<a href="#">
									<div class="user-img away">
										<img src="<?php echo _appURL;?>app/views/img/user6.png" alt="Admin Template">
									</div>
									<div class="details">
							...
							<li>
								<a href="#">
									<div class="user-img busy">
										<img src="<?php echo _appURL;?>app/views/img/user13.png" alt="Premium Admin Dashboards">
									</div>
									<div class="details">
							...
							<li>
								<a href="#">
									<div class="user-img online">
										<img src="<?php echo _appURL;?>app/views/img/user19.png" alt="Premium Admin Dashboards">
									</div>
									<div class="details">
					...
					<div class="dropdown-menu dropdown-menu-right lrg" aria-labelledby="notifications">
						...
						<ul class="header-notifications">
							<li>
								<a href="#">
									<div class="user-img away">
										<img src="<?php echo _appURL;?>app/views/img/user10.png" alt="Bootstrap Admin Panel">
									</div>
									<div class="details">
										<div class="user-title">Abbott</div>
										<div class="noti-details">Membership has been ended.</div>
							...
							<li>
								<a href="#">
									<div class="user-img busy">
										<img src="<?php echo _appURL;?>app/views/img/user10.png" alt="Admin Panel">
									</div>
									<div class="details">
										<div class="user-title">Braxten</div>
										<div class="noti-details">Approved new design.</div>
				...
				<li class="dropdown user-settings">
					<a href="#" id="userSettings" data-toggle="dropdown" aria-haspopup="true">
						<img src="<?php echo _appURL;?>app/views/img/user2.png" class="user-avatar" alt="Top Admin Dashboards">
					</a>
					<div class="dropdown-menu dropdown-menu-right" aria-labelledby="userSettings">
						<div class="header-profile-actions">
							<div class="header-user-profile">
								<div class="header-user">
									<img src="<?php echo _appURL;?>app/views/img/user2.png" alt="Admin Template">
								</div>
								<h5>Yuki Hayashi</h5>
								<p>Super User</p>
							</div>
					...
					<div class="card-body">
						<div class="customScroll5">
							<ul class="customer-rating">
								<li class="clearfix">
									<div class="customer">
										<img src="<?php echo _appURL;?>app/views/img/user.png" alt="Admin Templates and Dashboards">
									</div>
								...
								<li class="clearfix">
									<div class="customer">
										<img src="<?php echo _appURL;?>app/views/img/user2.png" alt="Admin Templates and Dashboards">
									</div>
									<div class="customer-review">
								...
								<li class="clearfix">
									<div class="customer">
										<img src="<?php echo _appURL;?>app/views/img/user3.png" alt="Admin Templates and Dashboards">
									</div>
									<div class="customer-review">
							...
							<div class="top-locations-container">
								...
								<div class="location">
									<div class="location-details">
										<img src="<?php echo _appURL;?>app/views/flags/4x3/br.svg" alt="Google Dashboard" />
								...
								<div class="location">
									<div class="location-details">
										<img src="<?php echo _appURL;?>app/views/flags/4x3/no.svg" alt="Google Dashboard" />
										<div class="location-name">
								...
								<div class="location">
									<div class="location-details">
										<img src="<?php echo _appURL;?>app/views/flags/4x3/ua.svg" alt="Google Dashboard" />
										<div class="location-name">
							...
							<div class="products-sold-container">
								<div class="product">
									<div class="product-details">
										<img src="<?php echo _appURL;?>app/views/img/mobiles/mob1.jpg" alt="Google Dashboard">
								...
								<div class="product">
									<div class="product-details">
										<img src="<?php echo _appURL;?>app/views/img/mobiles/mob2.jpg" alt="Google Dashboard">
										<div class="product-title">
								...
								<div class="product">
									<div class="product-details">
										<img src="<?php echo _appURL;?>app/views/img/mobiles/mob3.jpg" alt="Google Dashboard">
										<div class="product-title">
								...
								<div class="product">
									<div class="product-details">
										<img src="<?php echo _appURL;?>app/views/img/mobiles/mob4.jpg" alt="Google Dashboard">
										<div class="product-title">
								...
								<div class="product">
									<div class="product-details">
										<img src="<?php echo _appURL;?>app/views/img/mobiles/mob5.jpg" alt="Google Dashboard">
										<div class="product-title">
								...
								<div class="product">
									<div class="product-details">
										<img src="<?php echo _appURL;?>app/views/img/mobiles/mob6.jpg" alt="Google Dashboard">
										<div class="product-title">
								...
								<div class="product">
									<div class="product-details">
										<img src="<?php echo _appURL;?>app/views/img/mobiles/mob7.jpg" alt="Google Dashboard">
										<div class="product-title">
								...
								<div class="product">
									<div class="product-details">
										<img src="<?php echo _appURL;?>app/views/img/mobiles/mob8.jpg" alt="Google Dashboard">
										<div class="product-title">
						...
						<div class="customScroll5">
							<ul class="chats">
								...
								<li class="chats-right">
									<div class="chats-avatar">
										<img src="<?php echo _appURL;?>app/views/img/user4.png" alt="Admin Templates and Dashboards">
								...
								<li class="chats-left">
									<div class="chats-avatar">
										<img src="<?php echo _appURL;?>app/views/img/user10.png" alt="Admin Templates and Dashboards">
										<div class="chats-name">James</div>
									</div>
								...
								<li class="chats-right">
									<div class="chats-avatar">
										<img src="<?php echo _appURL;?>app/views/img/user22.png" alt="Admin Templates and Dashboards">
										<div class="chats-name">You</div>
									</div>
								...
								<li class="chats-left">
									<div class="chats-avatar">
										<img src="<?php echo _appURL;?>app/views/img/user17.png" alt="Admin Templates and Dashboards">
										<div class="chats-name">James</div>
									</div>
								...
								<li class="chats-right">
									<div class="chats-avatar">
										<img src="<?php echo _appURL;?>app/views/img/user9.png" alt="Admin Templates and Dashboards">
										<div class="chats-name">You</div>
									</div>
								...
								<li class="chats-left">
									<div class="chats-avatar">
										<img src="<?php echo _appURL;?>app/views/img/user12.png" alt="Admin Templates and Dashboards">
										<div class="chats-name">James</div>
									</div>
					...
					<div class="modal-body">
						<div class="call-container">
							<div class="current-user">
								<img src="<?php echo _appURL;?>app/views/img/user21.png" alt="Top Admin Dashboards">
							</div>
	...
	<div id="chat-box">
		<div id="chat-circle" class="btn btn-raised">
			<img src="<?php echo _appURL;?>app/views/img/chat.svg" alt="Best Google Dashboards" />
		</div>
		<div class="chat-box">
			...
			<div class="chat-box-body">
				<div class="chat-logs">
					<div class="chat-msg self">
						<img src="<?php echo _appURL;?>app/views/img/user2.png" class="user" alt="Google Dashboards">
						<div class="chat-msg-text">Hello</div>
					</div>
					<div class="chat-msg user">
						<img src="<?php echo _appURL;?>app/views/img/user15.png" class="user" alt="Google Dashboards">
